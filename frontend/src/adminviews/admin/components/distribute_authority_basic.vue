<template>
  <div>
    <div>
      ...
      <div
        class="my-auth-group">
        <h4 class="my-text">权限组：</h4>
        <div class="button_group my-text">
          <button
            type="button"
            class="btn"
            @click="chooseA">A</button>
          <button
            type="button"
            class="btn">B</button>
          <button
